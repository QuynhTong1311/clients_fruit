              ...
              <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center md:justify-start md:space-x-10">
                  ...
                  >
                    ...
                    <Link href="/offer">
                      <a className="relative inline-flex items-center h-6 bg-green-600 font-serif ml-4 py-0 px-2 rounded text-sm font-medium text-white hover:text-green-600">
                        {t("common:Offers")}
                        <div className="absolute flex w-2 h-2 left-auto -right-1 -top-1">
                          <span className="animate-ping absolute inline-flex h-2 w-2 rounded-full bg-green-700 opacity-75"></span>
