        ...
        <div className="flex justify-between items-center">
          <div className="lg:w-3/5">
            ...
            {t("common:promotional-banner-title-text")}
              <span className="text-green-600"> {t("common:promotional-banner-title-span")}</span>
            </h2>
            <p className="text-sm font-sans leading-6">
            {t("common:promotional-banner-paragraph-text")}
            </p>
            <Link href="#downloadApp">
              <a className="lg:w-1/4 text-xs font-serif font-medium inline-block mt-5 px-8 py-3 bg-green-600 text-center text-white rounded-full hover:text-white hover:bg-green-600">
